...
@XmlSeeAlso({
    ru.athena.edss.common.ObjectFactory.class,
    ru.athena.ws.edss.ObjectFactory.class
})
public interface EdssPortType {
    ...
    @RequestWrapper(localName = "DEVReestrInsert", targetNamespace = "http://www.athena.ru/ws/edss", className = "ru.athena.ws.edss.DEVReestrInsert")
    @ResponseWrapper(localName = "DEVReestrInsertResponse", targetNamespace = "http://www.athena.ru/ws/edss", className = "ru.athena.ws.edss.DEVReestrInsertResponse")
    ...
    @WebResult(name = "ErrorMessage", targetNamespace = "")
    @RequestWrapper(localName = "DEVReestrDelete", targetNamespace = "http://www.athena.ru/ws/edss", className = "ru.athena.ws.edss.DEVReestrDelete")
    @ResponseWrapper(localName = "DEVReestrDeleteResponse", targetNamespace = "http://www.athena.ru/ws/edss", className = "ru.athena.ws.edss.DEVReestrDeleteResponse")
